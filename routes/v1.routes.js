...
const orderEnquiryRoutes = require("./v1Routes/orderEnquiry.routes");
...
const subDivisionRoutes = require("./v1Routes/subDivision.routes");
...
v1Routes.use("/order-enquiry", orderEnquiryRoutes);
...
v1Routes.use("/sub-division", subDivisionRoutes);
