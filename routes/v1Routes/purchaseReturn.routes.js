...
const {purchaseretunrEditNew } = require("../../controllers/purchaseOrder/purchaseretunrEditNew.js");
...
purchaseReturnRoutes
  ...
  purchaseReturnRoutes
  .route("/edit-purchase-return-new/:purchaseReturnId")
  .patch(protectDisRoute, purchaseretunrEditNew);
  purchaseReturnRoutes
