...
// // to fetch product prices every day at 10pm
...
//         console.error("❌ Error Summary:", error.response.data.summary);
//       }
//     }
//   },
//   null,
...
// ============ DISTRIBUTOR BALANCE REBUILD - 4TH OF EACH MONTH @ 4:00 AM ============
// Runs on the 4th of every month at 4:00 AM to rebuild distributor balance

// const rebuildDistributorBalanceJob = new cron.CronJob(
//   "0 3 4 * *", // At 3:00 AM on the 4th of every month (IST)
//   async function () {
//     try {
//       console.log("🔄 Starting Distributor Balance Rebuild Cron...");

//       const res = await axios.post(
//         `${API_URL}/api/v1/rebuild-balance-cron/rebuild-distributor-balance`,
//       );

//       if (res.status === 200) {
//         console.log("✅ Distributor Balance Rebuild completed successfully");
//         console.log(
//           `   Distributors processed: ${res.data.distributors?.processed || 0}`,
//         );
//         console.log(
//           `   Transactions updated: ${res.data.distributors?.txnsUpdated || 0}`,
//         );
//       } else {
//         console.log(
//           "❌ Distributor Balance Rebuild returned non-200 status",
//           res.status,
//         );
//       }
//     } catch (error) {
//       console.error(
//         "🔥 Error during Distributor Balance Rebuild Cron:",
//         error.response?.data || error.message,
//       );
//     }
//   },
...
// ============ RETAILER BALANCE REBUILD - 4TH OF EACH MONTH @ 5:00 AM ============
// Runs on the 4th of every month at 5:00 AM to rebuild retailer balance (AFTER distributor)

// const rebuildRetailerBalanceJob = new cron.CronJob(
//   "0 4 4 * *", // At 4:00 AM on the 4th of every month (IST)
//   async function () {
//     try {
//       console.log("🔄 Starting Retailer Balance Rebuild Cron...");

//       const res = await axios.post(
//         `${API_URL}/api/v1/rebuild-balance-cron/rebuild-retailer-balance`,
//       );

//       if (res.status === 200) {
//         console.log("✅ Retailer Balance Rebuild completed successfully");
//         console.log(
//           `   Retailers processed: ${res.data.retailers?.processed || 0}`,
//         );
//         console.log(
//           `   Transactions updated: ${res.data.retailers?.txnsUpdated || 0}`,
//         );
//       } else {
//         console.log(
//           "❌ Retailer Balance Rebuild returned non-200 status",
//           res.status,
//         );
//       }
//     } catch (error) {
//       console.error(
//         "🔥 Error during Retailer Balance Rebuild Cron:",
//         error.response?.data || error.message,
//       );
//     }
//   },
